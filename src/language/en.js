export const english = {
    ...
    'Dont have a cutlery? Restaurant will provide you.':
        'Dont have a cutlery? chef will provide you.',
    'Minimum Order': 'Minimum Order',
    'Choose Food from  your Favourite Restaurants':
        'Choose Food from  your Favourite chefs',
    ...
    'No restaurant is available right now':
        'No chef is available right now',
    Email: 'Email',
    Joined: 'Joined',
    'No Subtitle Found': 'No Subtitle Found',
    'Term & Conditions': 'Term & Conditions',
    Other: 'Other',
    'Best Selling Restaurants': 'Best Selling chefs',
    'Popular Restaurants': 'Popular chefs',
    'New Restaurants': 'New chefs',
    'Search foods and restaurants....': 'Search foods and chefs....',
    'Positive Review': 'Positive Review',
    wallets: 'wallets',
    'Coupon Code': 'Coupon Code',
    Code: 'Code',
    'Restaurants Information': 'chefs Information',
    ...
    'All the best restaurants are one click away':
        'All the best chefs are one click away',
    ...
    'View all': 'View all',
    'New On StackFood': 'New On NammaOota',
    'Popular Restaurant': 'Popular chef',
    ...
    'VAT/TEX': 'VAT/TEX',
    'Restaurant Address': 'chef Address',
    'Restaurant Name': 'chef Name',
    'restaurant address required': 'chef address required',
    'restaurant name required': 'chef name required',
    ...
    'No restaurant found': 'No chef found',
    'You cannot order from multiple restaurants in a single order':
        'You cannot order from multiple chefs in a single order',
    'You have food from another restaurant in cart. If you continue, your all previous food from cart will be removed':
        'You have food from another chef in cart. If you continue, your all previous food from cart will be removed',
    ...
    'FIND BEST RESTAURANTS NEAR YOU': 'FIND BEST chefS NEAR YOU',
    ...
    'Restaurant Registration': 'chef Registration',
    ...
    debit: 'debit',
    credit: 'credit',
    'No Favourite Restaurant Found': 'No Favourite chef Found',
    ...
    'Stay upto date with restaurants and foods around you':
        'Stay upto date with chefs and foods around you',
    'Best Restaurants Near Your Location':
        'Best chefs Near Your Location',
    'Light Mode': 'Light Mode',
    'Dark Mode': 'Dark Mode',
    'Food Campaigns': 'Food Campaigns',
    'All Restaurants': 'All chefs',
    History: 'History',
    ...
    'Search foods in restaurant ': 'Search foods in chef ',
    ...
    'Minimum 200 points required to convert into currency':
        'Minimum 200 points required to convert into currency',
    'Only for  Restaurant': 'Only for  chef',
    ...
    'Stay upto date with restaurants and foods around you. Subscribe with email.':
        'Stay upto date with chefs and foods around you. Subscribe with email.',
    ...
    'Search a restaurant': 'Search a chef',
    ...
    Total: 'Total',
    'Restaurant Informations': 'chef Informations',
    ...
    'Become a restaurant owner': 'Become a chef owner',
    ...
    'Previously added restaurant foods have been removed from cart. Now, try again.':
        'Previously added chef foods have been removed from cart. Now, try again.',
    ...
    'No Cuisine Restaurant Found': 'No Cuisine chef Found',
    'Cuisine Restaurant': 'Cuisine chef',
    Cuisines: 'Cuisines',
    ...
    'This order can not be reordered as the restaurant is not existing in your current zone.':
        'This order can not be reordered as the chef is not existing in your current zone.',
    'ORDER TYPE &': 'ORDER TYPE &',
    ...
    'Restaurant Near from You': 'chef Near from You',
    Earn: 'Earn',
    ' when you ': ' when you ',
    ...
    'Get your recent food from the restaurant you recently visited':
        'Get your recent food from the chef you recently visited',
    ...
    "Offline Payment! Now, with just a click of a button, you can make secure transactions. It's simple, convenient, and reliable.":
        "Offline Payment! Now, with just a click of a button, you can make secure transactions. It's simple, convenient, and reliable.",
    'What’s on Your Mind?': 'What’s on Your Mind?',
    'Find Best Restaurants and Foods': 'Find Best chefs and Foods',
    Guest: 'Guest',
    ...
    'Please describe your problem to make you future experience more better':
        'Please describe your problem to make you future experience more better',
    'Remove this restaurant': 'Remove this chef',
    'Label As': 'Label As',
    ...
    'Please add you delivery location so that we can review if the restaurant is available to deliver in your area or not  ':
        'Please add you delivery location so that we can review if the chef is available to deliver in your area or not  ',
    'Pick from Map': 'Pick from Map',
    ...
    'New on': 'New on',
    'View Restaurants': 'View chefs',
    'Dine In': 'Dine In',
    'See our most popular restaurant and foods':
        'See our most popular chef and foods',
